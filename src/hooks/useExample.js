...
const useExamples = () => {
  ...
  const getExampleById = async (id) => {
    try {
      ...
      setError(
        error.response?.data?.message || `Error fetching example with id: ${id}`
      );
  ...
  const updateExample = async (id, updatedData) => {
    try {
      ...
      setError(
        error.response?.data?.message || `Error updating example with id: ${id}`
      );
  ...
  const deleteExample = async (id) => {
    try {
      ...
      setError(
        error.response?.data?.message || `Error deleting example with id: ${id}`
      );
